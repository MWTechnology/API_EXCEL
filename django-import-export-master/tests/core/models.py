...
class Book(models.Model):
    ...
    id_people = models.CharField("id_people", max_length=150, blank=True)
    description = models.CharField("description", max_length=150, blank=True)
    latitude_home = models.DecimalField("latitude_home", max_digits=19, decimal_places=6, blank=True)
    longitude_home = models.DecimalField("longitude_home", max_digits=19, decimal_places=6, blank=True)
    latitude_other = models.DecimalField("latitude_other", max_digits=19, decimal_places=6, blank=True)
    longitude_other = models.DecimalField("longitude_other", max_digits=19, decimal_places=6, blank=True)
    work_or_other = models.CharField("work_or_other", max_length=150, blank=True)

    def summa (self):
        return Book.objects.filter().count()
    def __str__(self):
